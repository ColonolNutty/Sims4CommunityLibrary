...
class CommonMixerInteraction(MixerInteraction, HasClassLog):
    ...
    @classmethod
    def on_replacement_constraints_gen(cls, inst_or_cls: 'CommonMixerInteraction', sim: Sim, target: Any) -> Union[Iterator[Constraint], None]:
        ...
        :type inst_or_cls: CommonMixerInteraction
    ...
    # noinspection PyUnusedLocal
    @classmethod
    def on_constraint_gen(cls, inst_or_cls: 'CommonMixerInteraction', sim: Sim, target: Any) -> Union[Iterator[Constraint], Constraint, None]:
    ...
    def _create_override_display_name(
        ...
        **interaction_parameters
        ...
        :param interaction_target: The target Object of the interaction.
        :type interaction_target: Any
        :param interaction: The interaction being performed or None. Default is None.
        :type interaction: CommonMixerInteraction, optional
        :param interaction_context: The context of the interaction being performed or None. Default is None.
    ...
    def set_current_progress_bar(self, percent: float, rate_change: float, start_message: bool=True):
        ...
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' set_current_progress_bar.'.format(self.__class__.__name__), exception=ex)
