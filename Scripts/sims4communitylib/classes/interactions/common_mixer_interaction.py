...
class CommonMixerInteraction(MixerInteraction, HasClassLog):
    ...
    def _test(cls, target: Any, context: InteractionContext, **kwargs) -> TestResult:
        ...
        try:
            try:
                ...
                cls.get_verbose_log().format_with_message('Test Result (CommonMixerInteraction)', test_result=test_result)
            except Exception as ex:
                cls.get_log().error('Error occurred while running mixer interaction \'{}\' on_test.'.format(cls.__name__), exception=ex)
                cls.get_verbose_log().format_with_message('Took {} seconds to return result from mixer interaction.'.format(stop_watch.stop()), class_name=cls.__name__)
                return TestResult.NONE
            ...
            try:
                ...
                cls.get_verbose_log().format_with_message('Super Test Result (CommonMixerInteraction)', super_test_result=super_test_result)
            except Exception as ex:
                cls.get_log().error('Error occurred while running mixer interaction \'{}\' super()._test.'.format(cls.__name__), exception=ex)
                cls.get_verbose_log().format_with_message('Took {} seconds to return result from mixer interaction.'.format(stop_watch.stop()), class_name=cls.__name__)
                return TestResult.NONE
            ...
            try:
                ...
                cls.get_verbose_log().format_with_message('Post Test Result (CommonMixerInteraction)', post_super_test_result=post_super_test_result)
            except Exception as ex:
                cls.get_log().error('Error occurred while running mixer interaction \'{}\' on_post_super_test.'.format(cls.__name__), exception=ex)
                cls.get_verbose_log().format_with_message('Took {} seconds to return result from mixer interaction.'.format(stop_watch.stop()), class_name=cls.__name__)
                return TestResult.NONE
            ...
            cls.get_log().error('Error occurred while running _test of mixer interaction \'{}\''.format(cls.__name__), exception=ex)
        cls.get_verbose_log().format_with_message('Took {} seconds to return result from mixer interaction.'.format(stop_watch.stop()), class_name=cls.__name__)
    ...
    def get_name(cls, inst: 'CommonMixerInteraction', target: Any=DEFAULT, context: InteractionContext=DEFAULT, **interaction_parameters) -> Union[LocalizedString, None]:
        ...
        try:
            ...
            cls.get_log().error('An error occurred while running get_name of mixer interaction {}'.format(cls.__name__), exception=ex)
    ...
    def _trigger_interaction_start_event(self: 'CommonMixerInteraction'):
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' on_started.'.format(self.__class__.__name__), exception=ex)

    # noinspection PyMissingOrEmptyDocstring
    def apply_posture_state(self, posture_state: PostureState, *args, participant_type: ParticipantType=ParticipantType.Actor, sim: Sim=DEFAULT, **kwargs):
        try:
            self.verbose_log.format_with_message(
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' modify_posture_state.'.format(self.__class__.__name__), exception=ex)
    ...
    def kill(self) -> bool:
        ...
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' on_killed.'.format(self.__class__.__name__), exception=ex)
        return super().kill()
    ...
    def cancel(self, finishing_type: FinishingType, cancel_reason_msg: str, **kwargs) -> bool:
        ...
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' cancel.'.format(self.__class__.__name__), exception=ex)
    ...
    def on_reset(self: 'CommonMixerInteraction'):
        ...
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' on_reset.'.format(self.__class__.__name__), exception=ex)
    ...
    def _post_perform(self: 'CommonMixerInteraction'):
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' _post_perform.'.format(self.__class__.__name__), exception=ex)
    ...
    def send_current_progress(self, *args: Any, **kwargs: Any):
        ...
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' send_current_progress.'.format(self.__class__.__name__), exception=ex)
    ...
    def setup_asm_default(self, asm: NativeAsm, *args, **kwargs) -> bool:
        ...
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' setup_asm_default.'.format(self.__class__.__name__), exception=ex)
    ...
    def _create_override_display_name(
        ...
        interaction: 'CommonMixerInteraction'=None,
        ...
        **interaction_parameters
        ...
        :type interaction: CommonMixerInteraction
    ...
    def set_current_progress_bar(self, percent: float, rate_change: float, start_message: bool=True):
        ...
        try:
            ...
            self.log.error('Error occurred while running mixer interaction \'{}\' set_current_progress_bar.'.format(self.__class__.__name__), exception=ex)
