...
class CommonInteraction(Interaction, HasClassLog):
    ...
    def get_participants(cls, inst, participant_type: ParticipantType, sim: Sim=DEFAULT, target: Any=DEFAULT, carry_target: Any=DEFAULT, **kwargs):
        ...
        try:
            ...
            if custom_participants is None:
                verbose_log.debug('Get Custom Replacement Participants did not return values, using the Normal Result instead (CommonInteraction)')
            else:
                verbose_log.format_with_message('Get Custom Participants Result (CommonInteraction)', custom_participants=custom_participants)
        ...
        try:
            ...
            if result:
                verbose_log.format_with_message('Super Get Participants Result (CommonInteraction)', result=result)
        except Exception as ex:
            log.error('Error occurred while running CommonInteraction \'{}\' super().get_participants.'.format(cls.__name__), exception=ex)
            return tuple()
    ...
    # noinspection PyUnusedLocal
    @classmethod
    def get_custom_replacement_participants(cls, participant_type: ParticipantType, sim: Union[Sim, None], target: Union[Sim, None], carry_target: Union[Any, None], interaction: 'CommonInteraction'=None, **kwargs) -> Union[Tuple[Any], None]:
        ...
        :type interaction: CommonInteraction, optional
    ...
    # noinspection PyUnusedLocal
    @classmethod
    def get_custom_participants(cls, participant_type: ParticipantType, sim: Union[Sim, None], target: Union[Sim, None], carry_target: Union[Any, None], interaction: 'CommonInteraction'=None, **kwargs) -> Tuple[Any]:
    ...
    def _create_override_display_name(
        ...
        interaction: 'CommonInteraction'=None,
        ...
        **interaction_parameters
        ...
        :type interaction: CommonInteraction
