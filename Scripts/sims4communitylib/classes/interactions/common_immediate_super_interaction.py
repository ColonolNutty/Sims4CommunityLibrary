    ...
    def _test(cls, target: Any, context: InteractionContext, **kwargs) -> TestResult:
        ...
        try:
            try:
                ...
                cls.get_verbose_log().format_with_message('Test Result (CommonImmediateSuperInteraction)', test_result=test_result)
            ...
            try:
                ...
                cls.get_verbose_log().format_with_message('Super Test Result (CommonImmediateSuperInteraction)', super_test_result=super_test_result)
            except Exception as ex:
            ...
            try:
                ...
                cls.get_verbose_log().format_with_message('Post Test Result (CommonImmediateSuperInteraction)', post_super_test_result=post_super_test_result)
            except Exception as ex:
