...
class CommonStringEnum(str):
    """
        An enum that holds a integer value.
    """
    def __init__(self, enum_name: str, enum_value: str):
        super().__init__()
...
class CommonEnumStringMetaclass(CommonEnumMetaclass):
    ...
    @classmethod
    def _get_common_enum(mcs, enum_name: str, enum_value: str):
        return CommonStringEnum(enum_name, enum_value)
